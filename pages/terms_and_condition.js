      ...
      <div class="min-h-screen">
        <section class="text-gray-900 body-font">
          <div class="text-black-600 mx-2 md:mx-10 my-2 py-24">
            <h2 class="px-10 py-2 text-gray-900 font-bold title-font tracking-wider text-4xl text-center mb-4">
              Terms &amp; Conditions</h2>
            <p class="px-10 py-2">
              These terms and conditions outline the rules and regulations for the use of Pixelwear's Website, located at www.pixelwear.vercel.app. By accessing this website we assume you accept these terms and conditions. Do not continue to use Pixelwear.in if you do not agree to take all of the terms and conditions stated on this page. The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company's terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client's needs in respect of provision of the Company's stated services, in accordance with and subject to, prevailing law of India. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
            <h1 class="mx-10 font-semibold text-2xl">
              Cookies</h1>
            <p class="px-10 py-2">
              We employ the use of cookies. By accessing Pixelwear.in, you agreed to use cookies in agreement with the Pixelwear's Privacy Policy. Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>
            <h1 class="mx-10 font-semibold text-2xl">
              License</h1>
            <p class="px-10 py-2">
              Unless otherwise stated, Pixelwear and/or its licensors own the intellectual property rights for all material on Pixelwear.in. All intellectual property rights are reserved. You may access this from Pixelwear.in for your own personal use subjected to restrictions set in these terms and conditions.</p>
            <div>
              <p class="mb-4 mx-10 font-semibold">
                You must not:</p>
              <li class="ml-10">
                Republish material from Pixelwear.in</li>
              <li class="ml-10">
                Sell, rent or sub-license material from Pixelwear.in</li>
              <li class="ml-10">
                Reproduce, duplicate or copy material from Pixelwear.in</li>
              <li class="ml-10">
                Redistribute content from Pixelwear.in</li>
            </div>
            <h1 class="mx-10 my-2">
            ...
            <h1 class="mt-4 mx-10 text-xl font-semibold">
              iFrames</h1>
            <p class="px-10 py-2">
