    ...
    <div>
      ...
      <div className="min-h-screen container mx-auto">
        <section className="text-gray-600 body-font">
          <div className="container mx-6 justify-center items-center flex px-5 py-24 flex-col">
            ...
            <div className="w-full">
              <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 flex justify-center">Welcome to MissNeha.in</h1>
        ...
        <section className="mt-8 text-gray-600 body-font mx-6">
          <h2 className="font-semibold my-2 text-3xl text-gray-900">About MissNeha</h2>
