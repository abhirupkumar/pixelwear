    ...
    <div>
      ...
      <div className="min-h-screen container mx-auto">
        ...
        <section className="mt-8 text-gray-600 body-font mx-6">
          ...
          <p className="mt-4 mb-8 leading-relaxed">Desi elements intermingle with contemporary styles giving birth to Pixelwear. The love affair is prominent in every Pixelwear Legging /Sarees giving the wearer an all encompassing ethnic experience. Integrating the modern Indian woman's quality, design and personal taste requirements. Pixelwear is the fusion fiesta in the wearers wardrobe.<br />The website kabirapparelss.com and the brand 'Pixelwear' are wholly owned and operated by KABIR TEXTILE & APPARELSS, incorporated in 2010, has its Textiles manufacturing plant at Ranaghat, near the city of joy, Kolkata.</p>
        </section>
      </div>
    </div>
  )
