    ...
    return (
        <div>
            ...
            <div className="text-gray-600 body-font min-h-screen flex lg:flex-row flex-col mt-10">
                {Object.keys(products).length !== 0 && <div className={`lg:mx-2 lg:my-12 lg:w-[300px] my-4 border border-gray-400 w-full rounded-md lg:h-full lg:relative sticky top-0 bg-white z-20 ${showFilter ? '' : 'lg:border-gray-400 border-gray-300'}`}>
                        ...
                        <div className={`flex flex-col px-10 mx-auto text-base`}>
                            <FormControl>
                                ...
                                <RadioGroup name='job-experience-group-label' aria-labelledby='job-experience-group-label' value={value} onChange={handleChange} col='true'>
                                    <FormControlLabel control={<Radio size='small' color='primary' />} value='ankleleggings' label={<span className='text-sm' >Ankle Leggings</span>} />
                                    <FormControlLabel control={<Radio size='small' color='primary' />} value='caprileggings' label={<span className='text-sm' >Capri Leggings</span>} />
                                    <FormControlLabel control={<Radio size='small' color='primary' />} value='churidarleggings' label={<span className='text-sm' >Churidar Leggings</span>} />
                                    <FormControlLabel control={<Radio size='small' color='primary' />} value='palazzo' label={<span className='text-sm' >Palazzo</span>} />
                                    <FormControlLabel control={<Radio size='small' color='primary' />} value='patiala' label={<span className='text-sm' >Patiala</span>} />
                                    <FormControlLabel control={<Radio size='small' color='primary' />} value='straightpant' label={<span className='text-sm' >Straight Pant</span>} />
                                </RadioGroup>
                            </FormControl>
                        </div>
