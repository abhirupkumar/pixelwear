                        ...
                        {Object.keys(products)?.map((item) => {
                            return <div key={products[item]._id} className="lg:w-[310px] w-[39%] cursor-pointer m-4 overlfow-x-hiden">
                                <Link href={`/product/${products[item].slug}`}>
                                    <div className="flex justify-center md:h-[470px] h-[216px] overflow-hidden transition duration-500 ease-in-out absolute opacity-100 hover:opacity-0 object-contain">
