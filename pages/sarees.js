    ...
    return (
        <div>
            ...
            <div className="text-gray-600 body-font min-h-screen flex lg:flex-row flex-col">
                {<div className={`lg:mx-2 lg:my-12 border border-gray-400 lg:w-[300px] w-full rounded-md lg:h-full lg:relative sticky bg-white z-20 ${showFilter ? '' : 'lg:border-gray-400 border-gray-300'} `}>
