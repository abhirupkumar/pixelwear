...
const Contact = () => {
  return (
    <div>
      <Head>
        <title>Contact Us - Pixelwear</title>
            ...
            <div>
              ...
              <div className="flex justify-between">
                <div className="text-center px-5 md:px-0 md:text-left py-10">
                  ...
                  <br />
                  2 no. Colony Ganganagar<br />
                  Madhyamgram, North Twenty Four Parganas,<br />
                  Kolkata - 700132, West Bengal India<br />
                </div>
                <div className="text-center px-5 md:px-0 md:text-left py-10">
                  <span className="font-bold">Customer Support</span>
                  <br />
                  Phone Number: <p className="inline-flex text-blue-600 font-semibold">+91-************</p>
                  <br />
                  Email: <p className="inline-flex text-slate-600 font-semibold">********@gmail.com</p>
                  <br />
                </div>
              </div>
            </div>
