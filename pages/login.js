          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6" method="POST">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href={'/forgot'}><div href="#" className="font-medium text-[#5377ec] hover:text-[#1a4ffd]"> Forgot Your Password? </div></Link>
              </div>
            </div>

            <div className="justify-center">
              {loading ? <CircularProgress color="secondary" /> : <button type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#1a4ffd] hover:bg-[#1440d3] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
