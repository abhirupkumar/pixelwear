        ...
        <div>
            <section className="text-gray-600 body-font min-h-screen">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    {Object.keys(products).length === 0 && <p>Sorry all the kids are currently out of stock. New stock comming soon. Stay Tuned!</p>}
    ...
    for (let item of products) {
        if (item.title in kids) {
            ...
            if (item.availableQty > 0) {
                ...
                kids[item.title].color = []
                kids[item.title].size = []
            }
        }
    }
    return {
        props: { products: JSON.parse(JSON.stringify(kids)) }, // will be passed to the page component as props
