...
const Kids = ({ products, filter }) => {
    ...
    const handleChange = (event) => {
        ...
        router.push(`/kids?category=${event.target.value}`)
    }
                        ...
                        <div className={`flex flex-col px-10 mx-auto text-base`}>
                            <FormControl>
                                ...
                                <RadioGroup name='job-experience-group-label' aria-labelledby='job-experience-group-label' value={value} onChange={handleChange} col='true'>
                                    <FormControlLabel control={<Radio size='medium' color='primary' />} value='bottom/ankleleggings' label='Ankle Leggings' />
                                    <FormControlLabel control={<Radio size='medium' color='primary' />} value='bottom/capri' label='Capri' />
                                    <FormControlLabel control={<Radio size='medium' color='primary' />} value='shorts' label='Shorts' />
                                </RadioGroup>
                            </FormControl>
                        </div>
