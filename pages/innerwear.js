...
const InnerWear = ({ products, filter, colorfilter, page, totalPages }) => {
    ...
    const applyFilters = () => {
        ...
        const filteredUrl = `/innerwear${queryString}`;
    ...
    useEffect(() => {
        setValue(router.query.category ? router.query.category : 'innerwear')
    }, [router])
